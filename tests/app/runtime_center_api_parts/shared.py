    ...
    def list_agents(
        ...
        agents = [
            ...
            },
            {
                ...
                "risk_level": "guarded",
                "current_focus_kind": "goal",
                "current_focus": "维持底层执行兼容兜底，不再作为业务团队执行脑暴露。",
        ...
        records = [
            {
                ...
                "current_focuses": ["Launch runtime center"],
            ...
            "actionable": [
                {
                    ...
                    "projection": {
                        "issue_source": "missing_capability",
                        "discovery_case_id": "case-gap-1",
                        "gap_kind": "missing_capability",
                        "baseline": {
                            "candidate_id": None,
                            "capability_ids": [],
                        ...
                        "challenger": {
                            "candidate_id": "candidate-gap-1",
                            "donor_id": "donor-remote-skill",
                            "package_id": "pkg-remote-skill",
                            "capability_ids": ["skill:nextgen_outreach"],
                            "summary": "Trial remote skill",
                        },
                        "trial_scope": {
                            "scope_kind": "seat",
                        ...
                        "lifecycle_decision": {
                            ...
                            "to_stage": "trial",
                            "reason": "Need one more scoped trial.",
                            "route": "/api/runtime-center/capabilities/lifecycle-decisions",
                        },
                        "donor_trust_impact": {
                            "donor_id": "donor-remote-skill",
                        ...
                        "planning_impact": {
                            ...
                            "future_review_pressure": True,
                            "replacement_pressure": False,
                            "retirement_pressure": False,
                            "revision_pressure": True,
                            "strategy_reopen_signals": ["lane-growth"],
                        },
                        "rollback_route": "/api/runtime-center/capabilities/lifecycle-decisions",
                        "writeback_targets": [
            ...
            "history": [
                {
                    ...
                    "projection": {
                        "issue_source": "capability_retirement",
                        "discovery_case_id": "case-gap-2",
                        "gap_kind": "capability_retirement",
                        "baseline": {
                            "candidate_id": None,
                            "capability_ids": ["skill:legacy_outreach"],
                            "summary": "skill:legacy_outreach",
                        },
                        "challenger": {
                            "candidate_id": "candidate-gap-2",
                            "donor_id": "donor-remote-skill",
                            "package_id": "pkg-remote-skill",
                            "capability_ids": ["skill:nextgen_outreach"],
                            "summary": "Retire legacy skill",
                        },
                        "trial_scope": {
                            "scope_kind": "seat",
                            "scope_ref": "env-browser-primary",
                        ...
                        "lifecycle_decision": {
                            ...
                            "from_stage": "trial",
                            "to_stage": "retired",
                            "reason": "Trial passed, legacy skill can retire.",
                            "route": "/api/runtime-center/capabilities/lifecycle-decisions",
                        },
                        "donor_trust_impact": {
                            "donor_id": "donor-remote-skill",
