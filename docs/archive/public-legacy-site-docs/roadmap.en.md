...
| **Spider Mesh-optimized local models**      | LLMs tuned for Spider Mesh's native skills and common tasks; better local personal-assistant usability                                                 | Long-term planned    |
...
We are building Spider Mesh in the open and welcome contributions of all kinds! Check the table above (especially items marked **Seeking Contributors**) to find areas that interest you, and read [CONTRIBUTING](https://github.com/15680676726/superSpider/blob/main/CONTRIBUTING.md) to get started. We particularly welcome:
...
Join the conversation on [GitHub Discussions](https://github.com/15680676726/superSpider/discussions) to suggest or pick up work.
