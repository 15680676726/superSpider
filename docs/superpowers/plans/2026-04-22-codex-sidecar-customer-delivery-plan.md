...
**Execution Status (`2026-04-22`):** Implemented on `main` via commits `b2767b2`, `8c96253`, `f9d2926`, `5155d33`, `f5c8c86`, with follow-up hardening recorded in `TASK_STATUS.md` `1.0.11`. The checkbox steps below remain as the original execution checklist.
