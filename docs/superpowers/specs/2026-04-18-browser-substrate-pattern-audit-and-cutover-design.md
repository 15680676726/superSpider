...
### 2.1 外部浏览器执行底座：值得直接采用的模式

基于公开浏览器工具文档与 `AGENTS.default`，可确认成熟浏览器执行底座通常有 4 个关键特征：
...
### 2.2 通用 computer-use 风格：可直接采用的模式
