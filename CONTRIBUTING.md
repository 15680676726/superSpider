...
- **Skills Hub:** CoPaw supports importing skills from SkillHub and compatible community hubs. If you want your skill to be installable via hub, follow the same `SKILL.md` + `references/`/`scripts/` layout and the hub’s packaging format.
