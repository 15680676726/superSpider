        ...
        with self._store.connection() as conn:
            conn.execute(
                ...
                INSERT INTO buddy_domain_capabilities (
                    ...
                    capability_score, capability_points, settled_closure_count,
                    independent_outcome_count, recent_completion_rate,
                    recent_execution_error_rate, distinct_settled_cycle_count,
                    demotion_cooldown_until, evolution_stage, knowledge_value, skill_value,
                ...
                ON CONFLICT(domain_id) DO UPDATE SET
                    ...
                    capability_points = excluded.capability_points,
                    settled_closure_count = excluded.settled_closure_count,
                    independent_outcome_count = excluded.independent_outcome_count,
                    recent_completion_rate = excluded.recent_completion_rate,
                    recent_execution_error_rate = excluded.recent_execution_error_rate,
                    distinct_settled_cycle_count = excluded.distinct_settled_cycle_count,
