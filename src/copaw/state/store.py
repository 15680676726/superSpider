...
CREATE TABLE IF NOT EXISTS buddy_domain_capabilities (
    ...
    capability_points INTEGER NOT NULL DEFAULT 0,
    settled_closure_count INTEGER NOT NULL DEFAULT 0,
    independent_outcome_count INTEGER NOT NULL DEFAULT 0,
    recent_completion_rate REAL NOT NULL DEFAULT 0,
    recent_execution_error_rate REAL NOT NULL DEFAULT 0,
    distinct_settled_cycle_count INTEGER NOT NULL DEFAULT 0,
    demotion_cooldown_until TEXT,
...
CREATE TABLE IF NOT EXISTS strategy_memories (
    ...
    strategy_trigger_rules_json TEXT NOT NULL DEFAULT '[]',
