...
def build_runtime_repositories(state_store: SQLiteStateStore) -> RuntimeRepositories:
    return RuntimeRepositories(
        ...
        human_assist_task_repository=SqliteHumanAssistTaskRepository(state_store),
        ...
        memory_relation_view_repository=SqliteMemoryRelationViewRepository(state_store),
        memory_reflection_run_repository=SqliteMemoryReflectionRunRepository(state_store),
        memory_sleep_repository=SqliteMemorySleepRepository(state_store),
