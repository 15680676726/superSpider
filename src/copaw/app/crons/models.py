...
class CronJobRequest(BaseModel):
    """Passthrough payload to kernel-backed system:dispatch_query.

    This is aligned with AgentRequest(extra="allow"). We keep it permissive so
    kernel ingress can forward arbitrary request fields.
    """
