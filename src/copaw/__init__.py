...
from .compatibility import ensure_agentscope_dict_mixin_deepcopy
...
PYDANTIC_DISABLED_DEFAULT = "logfire-plugin"

os.environ.setdefault(PYDANTIC_DISABLE_PLUGINS_ENV, PYDANTIC_DISABLED_DEFAULT)
ensure_agentscope_dict_mixin_deepcopy()
