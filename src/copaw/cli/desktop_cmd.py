# -*- coding: utf-8 -*-
"""CLI command: run Spider Mesh in a native webview window."""
...
def desktop_cmd(
    ...
    """Run Spider Mesh on an auto-selected free port in a webview window.
    ...
    click.echo(f"Starting Spider Mesh on {url} (port {port})")
