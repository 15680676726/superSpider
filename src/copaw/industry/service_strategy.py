    ...
    def _build_instance_detail(
        ...
        assignments = [

            {
                ...
                "route": (
                    ...
                    f"/api/runtime-center/tasks/{quote(assignment.task_id)}"

                    if assignment.task_id

                    else (

                        f"/api/runtime-center/goals/{quote(assignment.goal_id)}"

                        if assignment.goal_id

                        else lane_route_by_id.get(assignment.lane_id)
...

            {
                ...
                "route": (
                    ...
                    if report.task_id
                        ...
                        f"/api/runtime-center/goals/{quote(report.goal_id)}"
        ...
        backlog = [

            {
                ...
                "route": (
                    ...
                    f"/api/runtime-center/goals/{quote(item.goal_id)}"

                    if item.goal_id

                    else lane_route_by_id.get(item.lane_id)
        ...
        for goal_id in record.goal_ids:
            ...
            goal_entry = {
                ...
                "route": f"/api/runtime-center/goals/{goal.id}",
